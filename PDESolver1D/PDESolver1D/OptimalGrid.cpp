...
//	delete heat_pde;
	...
	//optimalExplicit << "xSize,tSize,Error,Time" << endl;

	for (unsigned long xSize = 10; xSize <= 50 ; xSize++)
	{
		...
		unsigned long tSize = xSize;
		for (unsigned long tSize = 10; tSize <= 50; tSize++)
		{
